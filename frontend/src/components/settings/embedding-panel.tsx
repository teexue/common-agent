...
export function EmbeddingPanel() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(([vs, cfg]) => {
        ...
        setModel(cfg.model || "")
        setDimensions(
          cfg.dimensions && cfg.dimensions > 0 ? cfg.dimensions : ""
        )
  ...
  const applyVendor = (v: EmbeddingVendorInfo) => {
    ...
    setDimensions(
      v.default_dimensions && v.default_dimensions > 0
        ? v.default_dimensions
        : ""
    )
  }
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setDimensions(
        saved.dimensions && saved.dimensions > 0 ? saved.dimensions : ""
      )
    ...
    <div className="space-y-3">
      ...
      <div className="space-y-1.5">
        ...
        <p className="text-[10px] text-muted-foreground">
          {t("settings.embeddingBaseUrlHint")}
        </p>
      </div>
        ...
        <>
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder={
                hasAPIKey ? t("settings.embeddingApiKeyKeep") : "sk-..."
              }
              className="h-9 rounded-xl font-mono text-xs"
            />
          </div>
      ...
      {showDimensions && (
        <div className="space-y-1.5">
          ...
          >
            ...
            <SelectContent className="rounded-xl">
              {dimensionOptions.map((d) => (
                <SelectItem
                  key={d}
                  value={{ value: String(d), label: String(d) }}
                >
                  {d}
                </SelectItem>
              ))}
          ...
          <p className="text-[10px] text-muted-foreground">
            {t("settings.embeddingDimensionsHint")}
          </p>
        </div>
      )}
