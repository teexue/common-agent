...
export function RequestLogsDialog({ open, onOpenChange, sessionId }: RequestLogsDialogProps) {
      ...
      <DialogContent className="!max-w-2xl sm:!max-w-2xl">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-sm">
            ...
            <Button variant="ghost" size="icon-xs" className="h-6 w-6 rounded-md" onClick={() => void load()}>
